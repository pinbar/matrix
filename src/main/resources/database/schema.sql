...
create table employees (
	...
	first_name varchar(250), last_name varchar(250)
);
...
create table timesheet_attachments (
    id int generated by default as identity(start with 1) primary key,
    file_name varchar(250) not null, content_type varchar(250) not null, content blob not null, timesheet_id int not null,
