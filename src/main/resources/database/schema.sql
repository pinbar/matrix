...
create table groups (
	id bigint generated by default as identity(start with 1) primary key,
	group_name varchar_ignorecase(50) unique not null
);
...
create table cost_center (
	...
	cost_code varchar(50) unique, name varchar(50) not null
);

create table timesheets (
	id int generated by default as identity(start with 1) primary key,
	week_ending date, status varchar(50), employee_id int not null,
	attachment_name varchar(250), attachment_content_type varchar(250), attachment_content blob,
...
--	unique(item_date, cost_code). How to validate this for an employee in timesheet_items
