...
public class TimesheetController {
	 ...
	 * public @ResponseBody List<TimesheetView> getPreviewAsJSON(Model model) {
	...
	@RequestMapping(value = "/addCostCodeRow/{timesheetId}", method = RequestMethod.GET)
	public String addCostCodeRow(@PathVariable int timesheetId,
			@RequestParam String costCode, Model model) {
		TimesheetView timesheetView = timesheetService.addCostCodeRow(
				timesheetId, costCode);
		model.addAttribute(MODEL_ATTRIBUTE_TIMESHEET, timesheetView);
		List<TimesheetView> tsPreviews = timesheetService.getTimesheetPreview();
		model.addAttribute(MODEL_ATTRIBUTE_TIMESHEET_LIST, tsPreviews);
		List<CostCenterView> costCenters = costCenterService.getCostCenters();
	...
	public String deleteTimesheetCostCodeRow(Model model, @PathVariable Integer timesheetId,
