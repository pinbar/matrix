	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				<div id="adminMsgs" class="${form !='admin' ? 'hide' : ''}">
					<ul>
						<li>Use the sidebar menu to manage users and groups.</li>
						<li>Hover over the headings to see sub-menu.</li>
						<li>Only 'Group/Employee List' and 'Add Group/Employee' menu
							items work at this time.</li>
						<li>Groups can be edited or deleted from the 'Group List'
							page (existing groups cannot be deleted).</li>
					</ul>
				</div>
				<div id="empList" class="${form != 'employeeList' ? 'hide' : ''}">
					<jsp:include page="employeeList.jsp" />
				</div>
				<div id="empUpdate" class="${form != 'employeeEdit' ? 'hide' : ''}">
					<jsp:include page="employeeEdit.jsp" />
				</div>
				<div id="grpList" class="${form != 'groupList' ? 'hide' : ''}">
					<jsp:include page="groupList.jsp" />
				</div>
				<div id="grpUpdate" class="${form != 'groupEdit' ? 'hide' : ''}">
