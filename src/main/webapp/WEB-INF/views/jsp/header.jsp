		...
		<div class="container-fluid">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
					...
					<li><a href="${pageContext.request.contextPath}/timesheet/"><i
							class="icon-file"></i> Timesheets</a></li>
					<li class="divider-vertical"></li>
					<li><a href="${pageContext.request.contextPath}/database/"><i
				...
				<div class="btn-group pull-right">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i> ${userInfo.firstName}
						${userInfo.lastName} <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<li><a href="#"><i class="icon-wrench"></i> Preferences</a></li>
						<li class="divider"></li>
						<li><a href="/${pageContext.request.contextPath}/logout"><i class="icon-share"></i>
								Logout</a></li>
					</ul>
				</div>
			</div>
