					...
					<table class="table table-striped table-bordered table-condensed">
						...
						<tbody>
							<c:if test="${timesheet != null}">						
								...
								<c:forEach items="${timesheet.tsCostCenters}" varStatus="status">
									<tr>
										<td><c:choose>
												<c:when test="${not empty costCenters}">
													<form:select path="tsCostCenters[${status.index}].costCode"
														class="input-medium">
														<form:options items="${costCenters}" itemValue="costCode"
															itemLabel="name" />
													</form:select>
												</c:when>
												<c:otherwise>
