			...
			<div class="span10">
				...
				<div class="span3">
					...
					<table
						...
						<tbody>
							<c:forEach var="groupMember" items="${db.groupMembers}">
								<tr>
				...
				<div class="span3">
					...
					<table
						...
						<tbody>
							<c:forEach var="groupAuthority" items="${db.groupAuthorities}">
								<tr>
				...
				<div class="span3">
					...
					<table
						...
						<tbody>
							<c:forEach var="employee" items="${db.employees}">
								<tr>
									<td>${employee.id}</td>
				...
				<div class="span3">
					...
					<table
						...
						<tbody>
							<c:forEach var="tsItems" items="${db.timesheetItems}">
								<tr>
									<td>${tsItems.id}</td>
				...
				<div class="span3">
					...
					<table
						...
						<tbody>
							<c:forEach var="cc" items="${db.costCenters}">
								<tr>
									<td>${cc.costCode}</td>
									<td>${cc.name}</td>
								</tr>
